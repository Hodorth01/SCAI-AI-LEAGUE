...
class PersonDetector():
    ...
    def detect_top_and_bottom_players(self, image, inv_matrix, filter_players=False):
        """
        Detects persons in the top and bottom of the tennis court using the homography matrix

        :param image: input image
        :param inv_matrix: inverse homography matrix
        :param filter_players: whether to filter out multiple players on the same side of the court
        :return: list of person bounding boxes at the top and bottom of the tennis court
        """
